	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'festival-glow': {
					'0%, 100%': { boxShadow: '0 0 5px hsl(var(--festival-gold))' },
					'50%': { boxShadow: '0 0 20px hsl(var(--festival-gold)), 0 0 30px hsl(var(--festival-gold))' }
				},
				'pulse-gentle': {
					'0%, 100%': { opacity: '1' },
					'50%': { opacity: '0.8' }
